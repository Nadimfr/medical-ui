...
const Button = ({ title, primary, secondary, onClick }) => {
  return (
    <div
      onClick={onClick}
      className={clsx(
        `w-full rounded-[15px] py-[10px] px-[15px] text-center 2xl:text-[20px] border-[2px] duration-300 cursor-pointer flex items-center justify-center whitespace-nowrap ${montserrat.className}`,
        {
